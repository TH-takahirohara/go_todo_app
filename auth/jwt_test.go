...
import (
	...
	"github.com/TH-takahirohara/go_todo_app/clock"
	"github.com/TH-takahirohara/go_todo_app/entity"
	"github.com/TH-takahirohara/go_todo_app/store"
	"github.com/TH-takahirohara/go_todo_app/testutil/fixture"
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
	  JwtID(uuid.New().String()).
		Issuer(`github.com/TH-takahirohara/go_todo_app`).
	...
	req := httptest.NewRequest(
		http.MethodGet,
		`https://github.com/TH-takahirohara`,
		nil,
	)
